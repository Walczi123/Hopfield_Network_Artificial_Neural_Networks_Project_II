...
if __name__ == "__main__":
    ...
    DISTURBED = 0 # NUMBER OF PIXELS THAT SHOULD BE DISTURBED IN TEST IMAGES
    ITER = 100 # NUMBER OF ITERATIONS IN PREDICT
    ASYNC_ITER = 1000 # NUMBER OF ITERATIONS IN ASYNC PREDICT
    PATHS = ['./data/sets/small-7x7.csv', './data/sets/large-25x25.csv','./data/big_set/ptak1-266x200.jpg', './data/stable-5x5-oja.csv'] # PATHS TO IMAGES
    NEURONS = [49, 625, None, 25] # NUMBER OF NEURONS FOR IMAGES ( SHOULD BE SET APPROPRIATELY TO CORRESPONDING PATH IN PATHS)
    IDX=3 # INDEX OF ELEMENTS IN PATHS AND NEURONS THAT WILL BE USED
